...
ICC=icc
OBJECTS=kohai.cpp
CXFLAGS-GP=-std=c++11 -pthread -O3 -march=corei7 --param max-inline-insns-auto=100 --param inline-min-speedup=25 -funroll-all-loops -fno-rtti -pthread -fprofile-generate
CXFLAGS-GR=-std=c++11 -pthread -O3 -march=corei7 --param max-inline-insns-auto=100 --param inline-min-speedup=25 -funroll-all-loops -fno-rtti -pthread -fprofile-use
